...
export class GameUtil{
    ...
    public static randomRange(minValue:number,maxValue:number){
     ...
     * @param value  0-100
     */
    public static hasProbability(value:number){
        return 100*Math.random()<value;
    }

    public static unTarget(src:Laya.Sprite,dst:Laya.Sprite,offset=30){
